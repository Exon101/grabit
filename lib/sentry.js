...
/* ------------------------------------------------------------------ *
 * Global error handlers — MUST be at module scope (initial evaluation)
 *
 * Chrome MV3 requires 'error' and 'unhandledrejection' listeners to be
 * added during the initial evaluation of the service worker script.
 * Adding them inside init() (which runs later, from onInstalled) causes:
 *   "Event handler of 'error' event must be added on the initial
