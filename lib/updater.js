 ...
 *      https://api.github.com/repos/Exon101/grabit-extension/releases/latest
...
const REPO = 'Exon101/grabit-extension';
 ...
 *     zipUrl:         'https://github.com/.../releases/download/v1.3.0/grabit-extension.zip',
 *     zipSize:        95000,
...
export async function downloadUpdate() {
  ...
  const filename = `GrabIt-Updates/grabit-extension-v${status.latestVersion}.zip`;
